...
void wlc_pointer_remove_view_for_resource(struct wlc_pointer *pointer, struct wl_resource *resource);
void wlc_pointer_free(struct wlc_pointer *pointer);
struct wlc_pointer* wlc_pointer_new(struct wl_list *views);
