...
Releases are signed with `B22DA89A <http://pgp.mit.edu/pks/lookup?op=vindex&search=0x52CB6609B22DA89A>`_ and published `on GitHub <https://github.com/Cloudef/wlc/releases>`_.
